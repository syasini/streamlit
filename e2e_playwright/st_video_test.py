...
def test_video_rendering(app: Page, assert_snapshot: ImageCompareFunction):
    ...
    video_element = _select_video_to_show(app, "url video")
    _wait_until_video_has_data(app, video_element)
    assert_snapshot(video_element, name="video_element_first")

    video_element = _select_video_to_show(app, "url video with start time")
    _wait_until_video_has_data(app, video_element)
    assert_snapshot(video_element, name="video_element_second")
