...
playwright:
	cd e2e_playwright; \
	rm -rf ./test-results; \
	pytest --ignore ${custom_components_test_folder} --browser webkit --browser chromium --browser firefox --output ./test-results/ -n auto --reruns 1 --reruns-delay 1 --rerun-except "Missing snapshot" --durations=5 -r aR -v
